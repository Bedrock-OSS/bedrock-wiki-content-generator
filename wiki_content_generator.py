...
def get_creative_categories_table(rp_path: str, version: str) -> list:
    ...
    categories = []
    with open(path.join(rp_path, 'texts', 'en_US.lang'), 'r') as lang_file:
...
def get_fogs_table(rp_path: str, version: str) -> list:
    ...
    biome_names = []
    fog_ids = []
    with open(path.join(rp_path, 'biomes_client.json'), 'r') as biomes_client:
...
def generate_vu_spawn_rules(bp_path: str, version: str, wiki_page_path: str, example_amount: int) -> None:
    ...
    wiki_page.write('---\n')
    if is_full:
        wiki_page.write('title: Vanilla Usage Spawn Rules - Full\n')
    else:
...
def generate_vu_items(bp_path: str, version: str, wiki_page_path: str, example_amount: int) -> None:
    ...
    wiki_page.write('---\n')
    if is_full:
        wiki_page.write('title: Vanilla Usage Components - Full\n')
    else:
